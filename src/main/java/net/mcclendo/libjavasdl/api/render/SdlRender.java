...
import net.mcclendo.libjavasdl.api.pixels.SDL_Renderer;
import net.mcclendo.libjavasdl.api.pixels.SDL_RendererInfo;
import net.mcclendo.libjavasdl.api.pixels.SDL_Texture;
import net.mcclendo.libjavasdl.api.rect.SDL_Point;
import net.mcclendo.libjavasdl.api.rect.SDL_Rect;
import net.mcclendo.libjavasdl.api.surface.SDL_Surface;
import net.mcclendo.libjavasdl.api.video.SDL_Window;
