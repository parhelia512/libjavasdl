...
public final class SdlGamecontroller {
     ...
     * information.
     * @see org.libsdl.api.joystick.SdlJoystick#SDL_JoystickGetDeviceGUID(int)
     * @see org.libsdl.api.joystick.SdlJoystick#SDL_JoystickGetGUID(SDL_Joystick)
     * @since This function is available since SDL 2.0.0.
     */
     ...
     * @see org.libsdl.api.joystick.SdlJoystick#SDL_JoystickEventState(int)
     * @since This function is available since SDL 2.0.0.
     */
