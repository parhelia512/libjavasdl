...
public final class SdlVideo {
     ...
     * @see #SDL_GetNumVideoDrivers()
     * @see #SDL_GetVideoDriver(int)
     * @see org.libsdl.api.Sdl#SDL_InitSubSystem(int) SDL_InitSubSystem(int)
     * @see #SDL_VideoQuit()
     * @since This function is available since SDL 2.0.0.
     */
     ...
     * @see org.libsdl.api.vulkan.SdlVulkan#SDL_Vulkan_GetDrawableSize(SDL_Window, IntByReference, IntByReference) SDL_Vulkan_GetDrawableSize(SDL_Window, IntByReference, IntByReference)
