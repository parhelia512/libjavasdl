 ...
 * with the {@link org.libsdl.api.SdlSubSystemConst#SDL_INIT_JOYSTICK SDL_INIT_JOYSTICK} flag.  This causes SDL to scan the system
...
public final class SdlJoystick {
     ...
     * @see org.libsdl.api.gamecontroller.SdlGamecontroller#SDL_GameControllerEventState(int)
     * @since This function is available since SDL 2.0.0.
     */
