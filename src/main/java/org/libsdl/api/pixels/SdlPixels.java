...
public final class SdlPixels {
     ...
     * @see #SDL_AllocPalette(int)
     * @see org.libsdl.api.surface.SdlSurface#SDL_CreateRGBSurface(int, int, int, int, int, int, int, int)
     * @since This function is available since SDL 2.0.0.
     */
     ...
     * @see org.libsdl.api.video.SdlVideo#SDL_SetWindowGammaRamp(SDL_Window, short[], short[], short[])
     * @since This function is available since SDL 2.0.0.
     */
