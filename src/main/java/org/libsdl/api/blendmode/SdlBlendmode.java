...
public final class SdlBlendmode {
     ...
     * operations.
     * @see org.libsdl.api.render.SdlRender#SDL_SetRenderDrawBlendMode(SDL_Renderer, int)
     * @see org.libsdl.api.render.SdlRender#SDL_GetRenderDrawBlendMode(SDL_Renderer, SDL_BlendMode.Ref)
     * @see org.libsdl.api.render.SdlRender#SDL_SetTextureBlendMode(SDL_Texture, int)
     * @see org.libsdl.api.render.SdlRender#SDL_GetTextureBlendMode(SDL_Texture, SDL_BlendMode.Ref)
