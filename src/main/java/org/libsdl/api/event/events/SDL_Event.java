...
import static org.libsdl.api.event.SdlEvents.SDL_AUDIODEVICEADDED;
import static org.libsdl.api.event.SdlEvents.SDL_AUDIODEVICEREMOVED;
import static org.libsdl.api.event.SdlEvents.SDL_CLIPBOARDUPDATE;
import static org.libsdl.api.event.SdlEvents.SDL_CONTROLLERAXISMOTION;
...
import static org.libsdl.api.event.SdlEvents.SDL_DROPCOMPLETE;
import static org.libsdl.api.event.SdlEvents.SDL_DROPFILE;
import static org.libsdl.api.event.SdlEvents.SDL_DROPTEXT;
import static org.libsdl.api.event.SdlEvents.SDL_FINGERDOWN;
import static org.libsdl.api.event.SdlEvents.SDL_FINGERMOTION;
import static org.libsdl.api.event.SdlEvents.SDL_FINGERUP;
import static org.libsdl.api.event.SdlEvents.SDL_JOYAXISMOTION;
import static org.libsdl.api.event.SdlEvents.SDL_JOYBALLMOTION;
import static org.libsdl.api.event.SdlEvents.SDL_JOYBUTTONDOWN;
import static org.libsdl.api.event.SdlEvents.SDL_JOYBUTTONUP;
import static org.libsdl.api.event.SdlEvents.SDL_JOYDEVICEADDED;
import static org.libsdl.api.event.SdlEvents.SDL_JOYHATMOTION;
import static org.libsdl.api.event.SdlEvents.SDL_KEYDOWN;
import static org.libsdl.api.event.SdlEvents.SDL_KEYUP;
import static org.libsdl.api.event.SdlEvents.SDL_LASTEVENT;
import static org.libsdl.api.event.SdlEvents.SDL_MOUSEBUTTONDOWN;
import static org.libsdl.api.event.SdlEvents.SDL_MOUSEBUTTONUP;
import static org.libsdl.api.event.SdlEvents.SDL_MOUSEMOTION;
import static org.libsdl.api.event.SdlEvents.SDL_MOUSEWHEEL;
import static org.libsdl.api.event.SdlEvents.SDL_MULTIGESTURE;
...
import static org.libsdl.api.event.SdlEvents.SDL_USEREVENT;
import static org.libsdl.api.event.SdlEvents.SDL_WINDOWEVENT;
