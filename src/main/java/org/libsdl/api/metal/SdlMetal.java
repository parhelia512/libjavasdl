...
public final class SdlMetal {
     ...
     * @see org.libsdl.api.video.SdlVideo#SDL_GetWindowSize(SDL_Window, IntByReference, IntByReference)
     * @see org.libsdl.api.video.SdlVideo#SDL_CreateWindow(String, int, int, int, int, int)
     * @since This function is available since SDL 2.0.14.
     */
